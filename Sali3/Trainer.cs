...
namespace Henkilosto
{
    ...
    class Trainer : Sali3.Henkilo
    {
        ...
        public Trainer(string etu, string suku, string katu, string ptno, string paikka, string ala, string puh, string email)
        {
            this.etunimi = etu;
            this.sukunimi = suku;
            this.katuosoite = katu;
            this.postinumero = ptno;
        ...
        public void naytaTrainer()
        {
            ...
            Console.WriteLine("Treini ala on " + this.ala);
